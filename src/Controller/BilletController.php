...
{
    //Je créée une constante qui contient tous mes articles.
    const billets = [
            1 => [
                "id" => 1,
            ...
            4 => [
                "id" => 4,
                "title" => "Le gouvernement a trois mois pour prouver qu’il respecte ses engagements climatiques,
    ...
    //Je créée ma route vers ma page qui contient tout mes articles
        /**
         * @Route("/billets", name="page_billets")
         */
    //Puis une nouvelle fonction
        public function billets(){

    //Je stocke dans une variable, mon appel a mes articles qui sont stockés dans la constante
            $billets = self::billets;

    //Puis je retoure grâce a ma fonction render mon fichier billets vers mon navigateur
